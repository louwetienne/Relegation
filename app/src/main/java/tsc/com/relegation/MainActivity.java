...
import tsc.com.relegation.NetworkCalls.UserFunctions;
...
//                }
    ...
    public void onInt(Bundle savedInstanceState) {
        ...
        mHelpLiveo.add("Dashboard", R.mipmap.ic_dashboard);
        mHelpLiveo.add("Smack Talk", R.mipmap.ic_smacktalk);
        mHelpLiveo.addSubHeader("+ Leaderboards"); //Item subHeader
        mHelpLiveo.add("Player Vs Player", R.mipmap.ic_leaderboard_playervsplayer);
        mHelpLiveo.add("Detailed", R.mipmap.ic_leaderboard_detailed);
        mHelpLiveo.add("History", R.mipmap.ic_leaderboard_history);
        mHelpLiveo.addSubHeader("+ Fixtures And Results"); //Item subHeader
        mHelpLiveo.add("Fixtures", R.mipmap.ic_fixtures);
        mHelpLiveo.add("Resuilts", R.mipmap.ic_results);
        mHelpLiveo.addSubHeader("+ Admin"); //Item subHeader
        mHelpLiveo.add("Add Fixtures", R.mipmap.ic_add_fixture);
        mHelpLiveo.add("Submit Results", R.mipmap.ic_submit_result);
        mHelpLiveo.addSeparator();
        mHelpLiveo.add("Logout", R.mipmap.ic_logout);

        with(this).startingPosition(0) //Starting position in the list
                .addAllHelpItem(mHelpLiveo.getHelp())
                .footerItem(R.string.settings, R.mipmap.ic_settings)
